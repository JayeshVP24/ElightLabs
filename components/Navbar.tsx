    ...
    return (
        <header
            className={`sticky transition-all duration-300 z-40 ${
                (bgTrans && !navModalOpen ) ? "bg-transparent" : "bg-background"
            } top-0   border-secondary border-opacity-100 rounded-b-3xl pb-5 mx-auto flex flex-col ${
                navModalOpen ? "border-b-4  " : "border-b-0"
            }`}
        >
            <nav className="flex self-center justify-between mt-5 items-center w-4/5 ">
                ...
                <div className="z-40 hidden lg:flex items-center justify-between w-4/6 text-sm text-secondary font-medium ">
                    {navs.map((n) => (
            ...
            <AnimatePresence>
                {navModalOpen && (
                    <m.div
                        ...
                        animate="animate"
                        exit="exit"
                        className="lg:hidden flex mx-[10%] flex-col  font-medium text-2xl my-16 justify-between "
                    >
                        <m.aside
                            initial={{
                                scale: 0,
