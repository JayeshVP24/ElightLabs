    ...
    return (
        <div className="relative md:max-w-xl lg:max-w-4xl bg-backgroundSecondar rounded-[40px] px-8 mb-20 ">
            ...
            <div  className="relative mt-6 -translate-y-16 md:translate-y-[-4.5rem] ">                
                <h2  className="font-bold max-w-xs mx-auto text-xl lg:text-2xl md:text-center relative md:-translate-y-5   ">{title}</h2>
                <h3 className="text-sm lg:text-base mt-1 mb-2 ">{description}</h3>
                <span className="text-lg lg:text-xl font-semibold">Technologies used</span>
