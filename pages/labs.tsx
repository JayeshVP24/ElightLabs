...
const Labs: NextPage = () => {
    const SEO: NextSeoProps = {
        title: "Labs | Elight Labs",
        description: "Projects made by devs at Elight Labs",
        openGraph: {
            title: "Labs | Elight Labs",
            description: "Projects made by devs at Elight Labs",
        },
    ...
    return (
        <LazyMotion features={domAnimation}>
            <div>
                ...
                <main>
                    {/* <section className="mx-7 md:mx-10 mt-14 mb-32 flex flex-col md:flex-row items-center justify-around ">
                    ...
                    <section className="mx-7 md:mx-10 mt-3 flex flex-col md:flex-row-reverse items-center justify-around ">
                        <div className="md:w-2/5">
                            ...
                            className="text-black font-semibold text-3xl  lg:text-[3rem] leading-[3rem] lg:leading-[5rem] ">
                                <span>Creating is <span className="text-primary" >Elight</span> </span>
                                <span>Designing is <span className="text-primary" >Elight</span> </span>
                                <span>Developing is <span className="text-primary" >Elight</span> </span>
                            </m.h1>
                        </div>
                        <div className="mt-5 md:w-2/5 ">
                            <img
                    ...
                    <section className="mx-5 mt-16 lg:mt-24">
                        <div className="relative md:px-10 flex -mb-8 items-center ">                            
                            <h2 className="text-2xl lg:text-4xl mx-auto font-semibold text-secondary flex flex-col ">
                                Projects pioneered by us
                            </h2>
                        </div>
                        <div className="md:w-[90%] mx-auto my-16 space-y-8 md:space-y-14 ">
                            <Product
                                title="Ogun Android Hosting Services"
                                year="2021"
                            ...
                            >
                                ...
                                <img
                                    ...
                                    width="1600"
                                    height="1200"
                                    src="https://ik.imagekit.io/elightlabs/elightlabs/work/tr:lo-true,pr-true/ogun.png"
                                    alt="img"
                                />
                            </Product>
                            {/* <Product
